...
var ConversationPanel = (function() {
  ...
  function init() {
    chatUpdateSetup();
	//getSample retrieves survey parameters from the server to be sent to conversation agent
	$.ajax({url: '/getSample', type:'post', async: false, success: function(result){
		$("#div1").html(result);
	}});
    var context = {
      'headline': sample,
